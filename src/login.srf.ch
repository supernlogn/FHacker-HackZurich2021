...
if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = "https://login.srf.ch";
...
if (!janrain.settings.actionText)janrain.settings.actionText = "Sign in with";
...
if (typeof janrain.settings.borderWidth === 'undefined')janrain.settings.borderWidth = 10;
if (typeof janrain.settings.borderColor === 'undefined')janrain.settings.borderColor = "#C0C0C0";
if (typeof janrain.settings.borderRadius === 'undefined')janrain.settings.borderRadius = 0;
if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = "fnglpmpccffogblndhpb";
if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = "https://login.srf.ch";
janrain.settings.permissions = ["customizable_auth_widget_hide_attribution", "customizable_auth_widget_styling"];
if (typeof janrain.settings.providers === 'undefined')janrain.settings.providers = ["facebook", "twitter", "apple"];
if (typeof janrain.settings.noReturnExperience === 'undefined')janrain.settings.noReturnExperience = false;
if (typeof janrain.settings.facebookAppId === 'undefined')janrain.settings.facebookAppId = "";
...
if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = "https://login.srf.ch";
janrain.settings.share.permissions = ["customizable_share_widget_email_mode", "customizable_share_widget_hide_attribution", "customizable_share_widget_styling", "customizable_share_widget_contact_mode"];
...
function getRootPath() {
    if (window.localStorage && localStorage.janrainLocalWidgetCodeEnabled === "true") {
        ...
        var rootPath = document.location.protocol === 'https:' ? "https://d29usylhdk1xyu.cloudfront.net/" : "http://d29usylhdk1xyu.cloudfront.net/";
    }
    return rootPath;
}
function getPackagePath(packages) {
    var rootPath = getRootPath();
    var path = rootPath + 'manifest/' + packages.join(':') + '?version=final';
    return path;
}
